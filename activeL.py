...
parser.add_argument('--noactive1', action='store_true', default=False, help='random choose')
parser.add_argument('--noactive2', action='store_true', default=False, help='choose after know all energy')
